  ...
  Future<void> fetchData() async {
    try {
      List<Map<String, dynamic>> fetchedPresenceList =
          await getPresenceByIdEmpDashboard(user!.data.userId!);
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              child: Text(
                translator.translate('LatestSession'),
                style: TextStyle(
                  fontFamily: "NexaBold",
                  fontSize: screenSize.width * 0.05,
                  color: Colors.white,
                ...
                children: [
                  Expanded(
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Text(translator.translate('Check In'),
                          style: TextStyle(
                            fontFamily: "NexaRegular",
                            fontSize: screenSize.width * 0.05,
            ...
            Text(translator.translate('Monthly Presence Summary'),
              style: GoogleFonts.raleway(
                textStyle: TextStyle(
            ...
            Wrap(
              ...
              children: [
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(translator.translate('Absent'),
                                style: GoogleFonts.raleway(
                                  textStyle: TextStyle(
                                      color: const Color.fromARGB(
                                          255, 255, 255, 255),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(translator.translate('All Presences'),
                                style: GoogleFonts.raleway(
                                  textStyle: TextStyle(
                                      color: const Color.fromARGB(
                                          255, 255, 255, 255),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(translator.translate('Late'),
                                style: GoogleFonts.raleway(
                                  textStyle: TextStyle(
                                      color: const Color.fromARGB(
                                          255, 255, 255, 255),
                ...
                SizedBox(
                  ...
                  width: screenSize.height * 0.2,
                  child: Card(
                    color: Color.fromARGB(181, 240, 118, 62),
                    elevation: 2,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(15.0),
                    ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(translator.translate('OnTime'),
                                style: GoogleFonts.raleway(
                                  textStyle: TextStyle(
                                      color: const Color.fromARGB(
                                          255, 255, 255, 255),
