...
import 'package:employee_attendance/models/Presence.dart';
...
//fetch presence
Future<List<Map<String, dynamic>>> getPresenceByIdEmp(String idEmployee) async {
  ApiResponse apiResponse = ApiResponse();
  String token = await getToken();
  Map<String, dynamic> requestBody;
  requestBody = {
